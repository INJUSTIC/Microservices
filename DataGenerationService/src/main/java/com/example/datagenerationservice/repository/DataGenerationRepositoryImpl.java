...
import com.example.datagenerationservice.model.CountryData;
import com.example.datagenerationservice.model.GeoPosition;
...
@Repository
public class DataGenerationRepositoryImpl implements DataGenerationRepository {
    String[] namePool;
    CountryData[] countryDataPool;

    public DataGenerationRepositoryImpl() {

        //pula imion dla dalniejszej losowej generacji
        namePool = new String[] {
    ...
    //generowanie listy obiektów o podanym rozmiarze
    @Override
